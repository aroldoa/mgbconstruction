...
;(function($){
    $(function(){
            ...
            if( $(this).scrollTop() + $(this).innerHeight() >= this.scrollHeight ) {
                ...
                $.post(
                    envira_gallery_metabox.ajax,
                    {
                        ...
                        offset:  $('.envira-gallery-gallery').attr('data-envira-gallery-offset'),
                        post_id: envira_gallery_metabox.id,
                    ...
                    function(response) {
                        // Update offset
                        var offset = Number( $('.envira-gallery-gallery').attr('data-envira-gallery-offset') );
                        $('.envira-gallery-gallery').attr('data-envira-gallery-offset', ( offset + 20 ) );
        ...
        $(document).on('keyup keydown', '#envira-gallery-gallery-search', function() {
            delay(function() {
                ...
                $.post(
                    ...
                    function(response) {
                        // Update offset
                        $('.envira-gallery-gallery').attr('data-envira-gallery-offset', 20 );
        ...
        $(document).on('click', '.query-results li.selected', function(e) {
        ...
        // Search: Hide when clicking outside of search results area
        $('input.link-search-field').change(function() {
            if ($(this).val() == '') {
